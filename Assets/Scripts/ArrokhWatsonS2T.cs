...
public class ArrokhWatsonS2T : MonoBehaviour
{
    [SerializeField]
    private bool m_debugSpeech;

    private string m_username = "75587d80-f12d-4b54-a60a-34bffd20edb4";
    private string m_password = "yTrI0wxndGyP";
    private string m_url = "https://stream.watsonplatform.net/speech-to-text/api";
    ...
    void Start()
    {
        Credentials credentials = new Credentials(m_username, m_password, m_url);
